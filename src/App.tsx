...
// Documentation pages
const SecretsRecovery = lazy(() => import("./pages/docs/SecretsRecovery"));
const BackupGuide = lazy(() => import("./pages/docs/BackupGuide"));
const MigrationGuide = lazy(() => import("./pages/docs/MigrationGuide"));
...
const AITextTemplateManager = lazy(() => import("./components/admin/AITextTemplateManager"));
          ...
          <BrowserRouter>
            ...
            <Suspense fallback={
              ...
              <Routes>
                ...
                <Route path="/agencia/configuracoes" element={<RoleProtectedRoute allow={['agency_admin']}><AgencySettings /></RoleProtectedRoute>} />
                ...
                <Route path="/agency/client/:clientId/conteudos" element={<RoleProtectedRoute allow={['super_admin', 'agency_admin', 'team_member']}><AgencyContentManager /></RoleProtectedRoute>} />
                ...
                <Route path="/docs/backup-guide" element={<RoleProtectedRoute allow={['super_admin']}><BackupGuide /></RoleProtectedRoute>} />
                <Route path="/docs/migration-guide" element={<RoleProtectedRoute allow={['super_admin']}><MigrationGuide /></RoleProtectedRoute>} />

...
export function WebhookTester() {
  ...
  const webhooks: WebhookDefinition[] = [
    ...
    {
      id: "client",
      name: "Webhook de Notificações de Clientes (GET)",
      description: "Boas-vindas, vencimentos, alertas de quota, relatórios (todas as agências)",
      key: "client_notifications_webhook_url",
      event: "test.client",
      payload: {
        event: "client.quota_alert",
    ...
    {
      id: "agency",
      name: "Webhook de Notificações de Agências (GET)",
